...
var ss_file = mp.utils.get_user_path("D:/Temp/mpv-ss-2-cb.png");
...
mp.add_key_binding("ctrl+c", "screenshot-to-clipboard", ss_2_cb);
mp.add_key_binding("ctrl+C", "sscreenshot-to-clipboard_video", ss_2_cb_video);
mp.add_key_binding("ctrl+alt+c", "sscreenshot-to-clipboard_window", ss_2_cb_window);